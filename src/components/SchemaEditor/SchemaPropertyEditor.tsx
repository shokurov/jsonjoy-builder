...
import { useComponent, useSlot } from "../../registry/SchemaBuilderRegistryContext.tsx";
...
const SchemaPropertyEditorFrame: React.FC<SchemaPropertyEditorFrameProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <FieldHeader data-jsonjoy-slot="field-header" className="flex items-center gap-2 grow min-w-0">
          {headerContent}
        </FieldHeader>
      ...
      {expanded && (
        ...
        >
          <FieldBody data-jsonjoy-slot="field-body">
            {bodyContent}
          </FieldBody>
        </div>
      )}
